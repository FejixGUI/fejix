...
..  toctree::
    ...
    pages/platforms-features
    pages/development/index
    pages/changelog
    Source <https://github.com/FejixGUI/fejix>

.. TODO Change this wordy marketing text to an actually useful index page

.. TODO Probably move this to an "Architecture" page and change the wording to
.. "Goals" and "Non-Goals"
