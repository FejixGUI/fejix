...
enum fj_error fj_io_thread_create_manager_x11(
    fj_io_thread_event_callback event_callback, struct fj_io_thread **out_io_thread)
{
    enum fj_error e;

    e = FJ_ALLOC_ZEROED(out_io_thread);
...
enum fj_error fj_io_thread_destroy_manager_x11(struct fj_io_thread *io_thread)
{
...
enum fj_error fj_io_thread_launched_x11(struct fj_io_thread *io_thread)
{
...
enum fj_error fj_io_thread_finished_x11(struct fj_io_thread *io_thread)
{
...
enum fj_error fj_io_thread_request_idle_x11(struct fj_io_thread *io_thread)
{
