...
static
fj_err_t output_data_init(struct fj_wayland_client * client)
{
...
static
fj_err_t output_init(struct fj_client * _client, struct fj_output_callbacks const * callbacks)
{
...
static
fj_err_t output_destroy(struct fj_client * _client, struct fj_output * _output)
{
    struct fj_wayland_client * client = (void *) _client;
    struct fj_wayland_output * output = (void *) _output;
    (void) client;
