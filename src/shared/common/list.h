...
#define FJ_LIST(LIST_TYPE_NAME, ITEM_TYPE)                                                     \
    ...
    {                                                                                          \
        ...
        return FJ_OK;                                                                          \
                                                                                               ...
                                                                                               \
    static inline fj_err LIST_TYPE_NAME##_remove(struct LIST_TYPE_NAME *list, uint32_t index)  \
    {                                                                                          \
        return fj_list_shrink(FJ_LIST_ARGS_(list), index);                                     \
    }                                                                                          \
                                                                                               \
    static inline fj_err LIST_TYPE_NAME##_append(struct LIST_TYPE_NAME *list, ITEM_TYPE *item) \
    {                                                                                          \
...
/**
    ...
    Returns #FJ_INVALID_USAGE or #FJ_OUT_OF_MEMORY.
*/
