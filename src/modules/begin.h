#ifndef FJ_INTERNAL_OPT_BACKEND_SUFFIX
#    error You need to #define FJ_INTERNAL_OPT_BACKEND_SUFFIX
#endif

#define FJ_CONCAT_(A, B) A##B
#define FJ_CONCAT(A, B) FJ_CONCAT_(A, B)
#define FJ_SUFFIXED(NAME) FJ_CONCAT(NAME##_, FJ_INTERNAL_OPT_BACKEND_SUFFIX)
