...
static char const *const error_descriptions[FJ_ERR_PREDEFINED_COUNT] = {
    ...
    [FJ_ERR_CANNOT_LOAD_LIBRARY] = "cannot load library",
    ...
    [FJ_ERR_IO_READ_FAILED] = "I/O read failed",
    [FJ_ERR_IO_WRITE_FAILED] = "I/O write failed",
    [FJ_ERR_IO_WAITING_FAILED] = "I/O waiting failed",
