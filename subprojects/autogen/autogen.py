...
class Autogen():
    autogen_header = "/* Automatically generated by autogen.py, do not edit! */\n\n"

    def __init__(self):
        script_dir = os.path.dirname(os.path.realpath(__file__))
        self.project_path = os.path.realpath(os.path.join(script_dir, ".."))

        self.input_path = os.path.join(self.project_path, "headers", "fejix", "interface")

        self.default_output_path = os.path.join(self.project_path, "default", "autogen")
        self.loader_output_path = os.path.join(self.project_path, "loader", "autogen")
