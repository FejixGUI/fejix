...
fj_err_t fj_app_create(struct fj_app **out_app, struct fj_app_create_info const *info)
{
    if (_fj_app_create_ptr != NULL) {
        return ((fj_err_t(*)(struct fj_app * *out_app, struct fj_app_create_info const *info))
                    _fj_app_create_ptr)(out_app, info);
    }
    return FJ_ERR_UNSUPPORTED;
}
...
void fj_app_on_idle(struct fj_app *app, fj_app_on_idle_fn_t callback)
{
    if (_fj_app_on_idle_ptr != NULL) {
        ((void (*)(struct fj_app *app, fj_app_on_idle_fn_t callback)) _fj_app_on_idle_ptr)(
            app, callback);
    }
...
void fj_app_on_finish(struct fj_app *app, fj_app_on_finish_fn_t callback)
{
    if (_fj_app_on_finish_ptr != NULL) {
        ((void (*)(struct fj_app *app, fj_app_on_finish_fn_t callback)) _fj_app_on_finish_ptr)(
            app, callback);
    }
    /* do nothing by default */;
}
...
void fj_app_on_notification(struct fj_app *app, fj_app_on_idle_fn_t callback)
{
    if (_fj_app_on_notification_ptr != NULL) {
        ((void (*)(struct fj_app *app, fj_app_on_idle_fn_t callback)) _fj_app_on_notification_ptr)(
            app, callback);
    }
    /* do nothing by default */;
}
...
void fj_app_wakeup_after_timeout(struct fj_app *app, fj_seconds_t timeout)
{
    if (_fj_app_wakeup_after_timeout_ptr != NULL) {
        ((void (*)(struct fj_app *app, fj_seconds_t timeout)) _fj_app_wakeup_after_timeout_ptr)(
            app, timeout);
    }
    /* do nothing by default */;
}
