...
FJ_APIVOID(fj_app_continue_event, struct fj_app *app)

FJ_APIVOID(fj_app_exit_event, struct fj_app *app)

FJ_APIVOID(fj_app_pause_event, struct fj_app *app)

FJ_APIVOID(fj_app_suspend_event, struct fj_app *app)

FJ_APIVOID(fj_app_resume_event, struct fj_app *app)
